(async function(){
  ...
  try{
    ...
    script.onload=async()=>{
      ...
      const v6=document.createElement('script');v6.src='features-v6.js';v6.async=false;document.body.appendChild(v6);
      if(ctx.isAdmin){const waha=document.createElement('script');waha.src='features-waha-test.js';waha.async=false;document.body.appendChild(waha)}
      loading.remove();
